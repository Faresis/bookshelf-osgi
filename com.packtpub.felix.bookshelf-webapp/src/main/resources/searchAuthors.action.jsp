...
<html>
    ...
    %>
        ...
        <form action="searchAuthors.action.jsp" method="get">
            Author: <input type="text" name="authorLike" value="<%= authorLike %>" />
            (use % for start and end wildcards)<br />
            <input type="submit" value="Search" />
        </form>

    <%
        if (!authorLike.equals("")) {
            Set<String> isbns = sessionBean.getBookshelf().searchBooksByAuthor(sessionBean.getSessionId(), authorLike);
    %>
